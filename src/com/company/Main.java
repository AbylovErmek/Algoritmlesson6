...
public class Main {
    ...
    public static void main(String[] args) {
        System.out.println("Player №1, пожалуйста введите ваше имя:");
        playerName1 = scanner.nextLine();
        System.out.println("Player №2, пожалуйста введите ваше имя:");
    ...
    public static void placeShips(String playerName, int[][] battlefield) {
        ...
        while (deck >= 1) {
            ...
            System.out.println("Пожалуйста введите координат OX:");
            int x = scanner.nextInt();
            System.out.println("Пожалуйста введите координат OY:");
